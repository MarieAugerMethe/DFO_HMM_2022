...
set.seed(1)
# Fit a 2 state HMM
GPS_linear <- fitHMM(prep_gps_linear, nbState = 2, dist = list(step = "gamma",
...
Unfortunately, if we fit an HMM to this data, it would likely classify 
